...
#np.savetxt('Mitra_et_al_2021b_TAU2.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Mitra_et_al_2021a_TAU2.txt',Result_my3,fmt="%f",delimiter=" ")

#For tau=3:
#np.savetxt('paper_algorithm2_TAU3.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU3.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Mitra_et_al_2021a_TAU3.txt',Result_my3,fmt="%f",delimiter=" ")

#For tau=4:
#np.savetxt('paper_algorithm2_TAU4.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU4.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Mitra_et_al_2021a_TAU4.txt',Result_my3,fmt="%f",delimiter=" ")

#For tau=5:
#np.savetxt('paper_algorithm2_TAU5.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU5.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Mitra_et_al_2021a_TAU5.txt',Result_my3,fmt="%f",delimiter=" ")

#For tau=6:
#np.savetxt('paper_algorithm2_TAU6.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU6.txt',Result_my2,fmt="%f",delimiter=" ")
#np.savetxt('Mitra_et_al_2021a_TAU6.txt',Result_my3,fmt="%f",delimiter=" ")

#For tau=7:
np.savetxt('paper_algorithm2_TAU7.txt',Result_my1,fmt="%f",delimiter=" ") 
np.savetxt('Mitra_et_al_2021b_TAU7.txt',Result_my2,fmt="%f",delimiter=" ")
np.savetxt('Mitra_et_al_2021a_TAU7.txt',Result_my3,fmt="%f",delimiter=" ")
