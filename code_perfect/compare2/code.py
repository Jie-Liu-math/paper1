...
#For tau=2:
np.savetxt('paper_algorithm1_(8)_TAU2.txt',Result_my1,fmt="%f",delimiter=" ") 
np.savetxt('paper_algorithm1_(7)_TAU2.txt',Result_my2,fmt="%f",delimiter=" ")
...
#For tau=3:
#np.savetxt('paper_algorithm1_(8)_TAU3.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('paper_algorithm1_(7)_TAU3.txt',Result_my2,fmt="%f",delimiter=" ")
...
#For tau=4:
#np.savetxt('paper_algorithm1_(8)_TAU4.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('paper_algorithm1_(7)_TAU4.txt',Result_my2,fmt="%f",delimiter=" ")
...
#For tau=5:
#np.savetxt('paper_algorithm1_(8)_TAU5.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('paper_algorithm1_(7)_TAU5.txt',Result_my2,fmt="%f",delimiter=" ")
...
#For tau=6:
#np.savetxt('paper_algorithm1_(8)_TAU6.txt',Result_my1,fmt="%f",delimiter=" ") 
#np.savetxt('paper_algorithm1_(7)_TAU6.txt',Result_my2,fmt="%f",delimiter=" ")
